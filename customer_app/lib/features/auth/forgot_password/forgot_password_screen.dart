...
import 'package:ridoo_customer/features/auth/otp/otp_screen.dart';
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Enter your registered phone number below. We will send you a verification code to reset your password.',
                  style: TextStyle(
                    fontSize: 15,
